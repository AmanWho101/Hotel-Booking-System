...
$sql = "select * from customer where fname='$name'";
$rslt = $conn->query($sql);
$row = $rslt->fetch_assoc();
$fname = $row['fname'];
$lname = $row['lname'];
$custid = $row['customerid'];
    ...
    if(isset($_POST['submit'])){
       ...
       $sql = "insert into reserved(customerid, arrival, departure, roomid, paid) values ('$custid','$arrival','$departure','$roomid','$roomp')";
       $rslt = $conn->query($sql);
        if($rslt){
                                                        ...
                                                        <div class="book_tabel_item">
                                                            <div class="form-group">
                                                                <div class='input-group date' id='datetimepicker11'>
                                                                    <input name="arrival" type='text' class="form-control" placeholder="Arrival Date" />
                                                            ...
                                                            <div class="form-group">
                                                                <div class='input-group date' id='datetimepicker1'>
                                                                    <input name="departure" type='text' class="form-control" placeholder="Departure Date" />
                                                                    <span class="input-group-addon">
                                                                        <i class="fa fa-calendar" aria-hidden="true"></i>
                                                                    </span>
                                                                </div>
                                                            ...
                                                            <div class="book_tabel_item">
                                                                <div class="input-group">
                                                                    <input name="roomt" type="text" class="form-control" value="<?php echo $roomt;?>" disabled>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="book_tabel_item">
                                                            ...
                                                            <div class="book_tabel_item">
                                                                <div class="input-group">
                                                                    <input name="roomP" class="form-control" type="text" value="<?php echo $roomp;?>" disabled>
                                                                </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-9">
                                                                        <input name="fname" type="text" value="<?php echo $fname;?>" class="form-control" disabled/>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-9">
                                                                        <input name="lname" type="text" value="<?php echo $lname;?>" class="form-control" disabled/>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <button name="submit" class="book_now_btn button_hover">Book Now</button>
                                                    </form>
                                                </div>
                                            </div>
                                        </div>
