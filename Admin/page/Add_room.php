        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="register_receptionist.html">
                            <i class="mdi mdi-account-plus menu-icon"></i>
                            <span class="menu-title">Add Receptionist</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="update_receptionist.html">
                            <i class="mdi mdi-pen menu-icon"></i>
                            <span class="menu-title">Update Receptionist</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="Add_room.html">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="update_room.html">
                            <i class="mdi mdi-pen">
                                <i class="mdi mdi-hotel menu-icon"></i></i>
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" enctype="multipart/form-data" class="forms-sample">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="roomN" type="text" class="form-control" id="exampleInputName1"
                                                placeholder="Room Number">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail3">Room Floor</label>
                                            <input name="roomF" type="text" class="form-control" 
                                                placeholder="Room Floor">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword4">Room Price</label>
                                            <input name="roomP" type="text" class="form-control"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="input-group col-xs-12">
                                                ...
                                                <span class="input-group-append">
                                                    <input type="file" name="img" accept="image/*" onchange="loadFile(event)" class="btn btn-primary" />
                                                </span>
                                            </div>
                                        </div>
