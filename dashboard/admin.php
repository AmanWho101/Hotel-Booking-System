  ...
  <div class="container-fluid page-body-wrapper">
    ...
    <nav class="sidebar sidebar-offcanvas" id="sidebar">
      <ul class="nav">
        ...
        <li class="nav-item">
          <a class="nav-link" href="page/register_receptionist.php">
        ...
        <li class="nav-item">
          <a class="nav-link" href="page/Add_room.php">
                  ...
                  <table id="recent-purchases-listing" class="table">
                    ...
                    <tbody>
                        ...
                        while($row = $rslt->fetch_assoc()){
                          ...
                          <td>'.$row['email'].'</td>
                          <td>'.$row['passwords'].'</td>
                          <td><button class="btn btn-primary"><a href="page/update_receptionist.php?updateid='.$row['recepid'].'" class="text-light">Edite</a></button>
                          <button class="btn btn-warning"><a href="page/delete.php?deleteid='.$row['recepid'].'" class="text-light">Delete</a></button>
                          </td></tr>';
                        }
                        ?>
                ...
                <div class="table-responsive">
                  <table id="recent-purchases-listing" class="table">
                    ...
                    <?php
                        ...
                        $rslt = $conn->query($sql);
                        while($row = $rslt->fetch_assoc()){
                          echo '<tr><td>'.$row['roomtype'].'</td>
                          <td>'.$row['roomNo'].'</td>
                          <td>'.$row['roomFloor'].'</td>
                          <td>'.$row['roomPrice'].'$ </td>
                          <td><img src="Himages/'.$row['images'].'"/></td>
                          <td><button class="btn btn-primary"><a href="page/update_room.php?updateid='.$row['roomid'].'" class="text-light">Edite</a></button>
                          <button class="btn btn-warning"><a href="page/deleteR.php?deleteid='.$row['roomid'].'" class="text-light">Delete</a></button>
                          </td></tr>';
                        }
                        ?>
                    </tbody>
