        ...
        <div class="content-wrapper">
          <div class="row">
            ...
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Comment 1: This is comment 1</h4>
                  <div class="card" style="width: 18rem;">
                    <div class="card-body">
                      ...
                      <p>Comment 5: This is comment 5</p>
                      <button class="replybutton" data-commentbox="panel5">Reply</button>

                      <div class="replybox" style="display:none" id="panel5">
